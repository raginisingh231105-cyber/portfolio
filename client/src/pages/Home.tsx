...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center px-8 md:px-20 pt-20">
      <div className="max-w-4xl z-10 flex flex-col md:flex-row md:items-center md:gap-12">
        ...
        <div className="hero-avatar-wrapper flex justify-center md:justify-end mb-8 md:mb-0">
          <img src="/ragini-profile.jpg" alt="Ragini Profile" className="hero-avatar" />
        </div>
      </div>
    </div>
  );
